...
console.clear(); console.log('- seq_10_App.delete.js --------');
...
function App() {
    ...
    switch(mode) {
        ...
        case 2: // READ
            ...
            contextControl = <>
                    <li>
                        <a href={ '/update/' + topicId } onClick={ e => {   // e => void
                    ...
                    <li><input type='button' value='Delete' onClick={ () => {   // () => void
                            console.debug('contextControl::input::onClick() invoked.');

                            // -----------------------------------
                            // Delete the current topic from topics array.
                            // -----------------------------------

                            /**
                            // 1st. method: using empty array && for-of.
                            const newTopics = [];
                            ...
                            */
                            ...
                            /**
                            // 2nd. method: using new deep copied topics & Array.splice(startIndex, deleteCount) method
                            */
                            const newTopics = [...topics];

                            newTopics.forEach((t, index, _) => {
                                if(t.id === topicId) newTopics.splice(index, 1);
                            });

                            // If deleting first element from topics, deleting result is incorrect.
                            // newTopics.splice(topicId - 1, 1);           // XX

                            console.info('\t+ newTopics:', newTopics);

                            setTopics(newTopics);   // Update topics.
                            setMode(1);             // Update mode.
                    }} /></li>
                </>;
