...
function App(props) {   // Returns React.JSX.Element
  ...
  if(mode === "WELCOME") {
    ...
    // --------------
    // <> ~ </> - Empty Tag : To package several sub tags in React.   (***)
    //            This empty tag does *NOT* be displayed in real tag. (***)
    ...
    contextControl = <>
        ...
        <li><input type="button" value="Delete" onClick={() => {
          ...
          setTopics(newTopics);   // Update topics state -> re-render
          setMode("WELCOME");     // Update mode state -> re-render
        }} /></li>
      </>;
